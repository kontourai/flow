...
* Enforce trusted producer pins during canonical and pure trust attachment evaluation; the independently versioned trust attachment reducer is now 1.3.4, evaluates rich Surface authority traces through one immutable snapshot of its explicit dependency adapter at the supplied instant, fingerprints every supported helper in its published identity, rejects substituted or access-varying helpers, and preserves exact RFC3339 chronology beyond JavaScript millisecond precision.
...
* **runtime:** assert recovery inputs before fence reopen ([#193](https://github.com/kontourai/flow/issues/193)) ([6888dfc](https://github.com/kontourai/flow/commit/6888dfcf6717fda77cf560d99b9abf7aad432227))

## [3.11.0](https://github.com/kontourai/flow/compare/v3.10.0...v3.11.0) (2026-07-28)


### Features

* support deferred trust attachment evaluation ([#191](https://github.com/kontourai/flow/issues/191)) ([1e3dcf6](https://github.com/kontourai/flow/commit/1e3dcf6719cef68f22eb855da69b29c6f47919d1))


### Documentation

* use US spellings ([#186](https://github.com/kontourai/flow/issues/186)) ([320f617](https://github.com/kontourai/flow/commit/320f617d1d46677891973a0f540dc485b84c3321))
...
* add run recovery fence ([#175](https://github.com/kontourai/flow/issues/175)) ([f750ad2](https://github.com/kontourai/flow/commit/f750ad2959d3d5ce1dff7807cf803dca30531c46))

## [3.7.0](https://github.com/kontourai/flow/compare/v3.6.2...v3.7.0) (2026-07-22)


### Features

* continue paused gates atomically ([5472fd6](https://github.com/kontourai/flow/commit/5472fd62833a7306fc2787fa09f331a65615650e))
* continue paused gates atomically ([#172](https://github.com/kontourai/flow/issues/172)) ([8254c84](https://github.com/kontourai/flow/commit/8254c84e9c383ba9799ef8d4f4b9da380d7331cf))

## [3.6.2](https://github.com/kontourai/flow/compare/v3.6.1...v3.6.2) (2026-07-22)


### Fixes

* allow additive routes after historical gate outcomes ([d8bf552](https://github.com/kontourai/flow/commit/d8bf5528447a0094fef230cac501f3c54f123a46))
...
* **runtime:** authorize bounded retry epochs ([#141](https://github.com/kontourai/flow/issues/141)) ([4f9d073](https://github.com/kontourai/flow/commit/4f9d073afa15bcd4a4e5fce89f27a07a10774a72))

## [3.3.0](https://github.com/kontourai/flow/compare/v3.2.0...v3.3.0) (2026-07-17)


### Features

* **examples:** live/post-deploy verification as a first-class passive pattern ([#138](https://github.com/kontourai/flow/issues/138)) ([b5446d4](https://github.com/kontourai/flow/commit/b5446d4e91b34aacf741a9b3b83b9b718e4d9f5a)), closes [#135](https://github.com/kontourai/flow/issues/135)
...
* reroute stale upstream gates automatically ([#128](https://github.com/kontourai/flow/issues/128)) ([#129](https://github.com/kontourai/flow/issues/129)) ([34aad25](https://github.com/kontourai/flow/commit/34aad2579de6a079ed0b365e068e2fe80e225566))

## [3.1.3](https://github.com/kontourai/flow/compare/v3.1.2...v3.1.3) (2026-07-11)


### Fixes

* require current claims after gate re-entry ([#126](https://github.com/kontourai/flow/issues/126)) ([d7b2446](https://github.com/kontourai/flow/commit/d7b2446f8bac547b06eebc0c52e11cc94d69b3ce))

## [3.1.2](https://github.com/kontourai/flow/compare/v3.1.1...v3.1.2) (2026-07-11)


### Fixes

* scope evidence to the current gate visit ([#123](https://github.com/kontourai/flow/issues/123)) ([00e859d](https://github.com/kontourai/flow/commit/00e859db8b15eb534c2e9b42f88e46bbaee95d5d))
...
* add canonical Flow Run lifecycle authority ([#116](https://github.com/kontourai/flow/issues/116)) ([1abc91d](https://github.com/kontourai/flow/commit/1abc91de28ec36ce666ca450ed244f299caa6d40))
