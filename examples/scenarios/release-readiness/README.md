...
`release-policy.json` defines open release lane ids and risk classes. Each lane names the release claim type and accepted statuses required for that lane. The equivalent Flow Definition uses current `trust.bundle` gate expectations.
