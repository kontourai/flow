...
- [ADR 0007: Flow / Skill / Kit / Tool Boundary](https://kontourai.github.io/flow-agents/adr/0007-flow-skill-kit-tool-boundary) — the skill/tool boundary; same conversation.
