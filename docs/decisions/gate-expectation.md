...
This subject has provenance in frozen ADR history ([0002-gate-expectations-and-project-authority.md](../adr/0002-gate-expectations-and-project-authority.md)) but no living
...
When a living decision is ratified for gate expectation,
