...
| Examples and fixtures | Update examples only as the demonstrated contracts migrate; do not create standalone example resources. | Existing example validation plus schema drift checks. |
